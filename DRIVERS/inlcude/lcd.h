...
#define _USE_CGRAM							1			/* 1:Enable custom character functions */
#define _USE_CUSTOM_CHAR 				1 		/* Enable variables & functions for custom char */
/**************************************************************************************************/
...
#define LCD_EN 					P1_28    	/* To Enable the Display */
...
****************************************************************************************************/
	...
	extern uint8_t four[];
	extern uint8_t five[];
	extern uint8_t custom_char[];	

	extern uint8_t 	signalBar[];
	extern uint8_t	custom_MarginalSignal[];
	extern uint8_t	custom_OKSignal[];
	extern uint8_t	custom_GoodSignal[];
	extern uint8_t	custom_ExcellentSignal[];
	

	
	extern uint8_t logo_00[];
	extern uint8_t logo_01[];
	extern uint8_t logo_02[];
	extern uint8_t logo_10[];
	extern uint8_t logo_11[];
	extern uint8_t logo_12[];
...
/**************************************************************************************************/
	...
	extern uint8_t char_K[];
	extern uint8_t char_Y[];
	extern uint8_t char_S4[];
	extern uint8_t char_E[];
	extern uint8_t char_N[];
	extern uint8_t char_S8[];
	extern uint8_t char_E2[];
	void Init_display_name( void );
	void Progress_displayName( int);
//	void Progress_displaydot(char, char, char );
