...
/***************************************************************************************************
                            Custome symbols define
***************************************************************************************************/

#if _USE_CGRAM
	// Custom char data (progress bar symbols)
	uint8_t zero[] = {0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00};
	uint8_t one[] = {0x10,0x10,0x10,0x10,0x10,0x10,0x10,0x10};
	uint8_t two[] = {0x18,0x18,0x18,0x18,0x18,0x18,0x18,0x18};
	uint8_t three[] = {0x1C,0x1C,0x1C,0x1C,0x1C,0x1C,0x1C,0x1C};
	uint8_t four[] = {0x1E,0x1E,0x1E,0x1E,0x1E,0x1E,0x1E,0x1E};
	uint8_t five[] = {0x1F,0x1F,0x1F,0x1F,0x1F,0x1F,0x1F,0x1F};

	// Custom char data (battery symbols)
	uint8_t custom_char[] = { 0x0E, 0x1B, 0x11, 0x11, 0x11, 0x11, 0x11, 0x1F };	

	// Custom char data (signal strenth symbols)
	uint8_t	custom_MarginalSignal[] = {0x00,0x00,0x00,0x00,0x00,0x00,0x08,0x18};
	uint8_t	custom_OKSignal[] = {0x00,0x00,0x00,0x00,0x00,0x04,0x0C,0x1C};
	uint8_t	custom_GoodSignal[] = {0x00,0x00,0x00,0x00,0x02,0x06,0x0E,0x1E};
	uint8_t custom_ExcellentSignal[] = {0x1,0x1,0x1,0x5,0x5,0x15,0x15,0x15};
	
	uint8_t signalBar[] = {0x1f,0xe,0xe,0x4,0x4,0x4,0x4,0x4};

	// Custom char data (SYKSENSE symbols)
	//uint8_t char_S[] = {0xe,0x1b,0x18,0x1e,0x3,0x1b,0xe,0x0};
	//uint8_t char_K[] = {0x19,0x19,0x1a,0x1c,0x1a,0x19,0x19,0x0};
	//uint8_t char_Y[] = {0xa,0x1b,0x1b,0xe,0x4,0x4,0x4,0x0};
	//uint8_t char_S4[] = {0xe,0x1b,0x18,0x1e,0x3,0x1b,0xe,0x0};
	//uint8_t char_E[] = {0x1f,0x18,0x18,0x1e,0x18,0x18,0x1f,0x0};
	//uint8_t char_N[] = {0x11,0x11,0x19,0x1d,0x17,0x13,0x11,0x0};
	//uint8_t char_S8[] = {0xe,0x1b,0x18,0x1e,0x3,0x1b,0xe,0x0};
	//uint8_t char_E2[] = {0x1f,0x18,0x18,0x1e,0x18,0x18,0x1f,0x0};
	
	uint8_t char_S[] = {0xf,0x18,0x1f,0x3,0x1e,0x0,0x1f,0x0};
	uint8_t char_K[] = {0x19,0x1a,0x1c,0x1a,0x19,0x0,0x1f,0x0};
	uint8_t char_Y[] = {0x1B,0x1B,0x0A,0x04,0x04,0x00,0x1F,0x00};
	uint8_t char_S4[] = {0xf,0x18,0x1f,0x3,0x1e,0x0,0x1f,0x0};
	uint8_t char_E[] = {0x1f,0x18,0x1e,0x18,0x1f,0x0,0x1f,0x0};
	uint8_t char_N[] = {0x11,0x19,0x1d,0x17,0x13,0x0,0x1f,0x0};
	uint8_t char_S8[] = {0xf,0x18,0x1f,0x3,0x1e,0x0,0x1f,0x0};
	uint8_t char_E2[] = {0x1f,0x18,0x1e,0x18,0x1f,0x0,0x1f,0x0};
	
	// Custom char data (SYKSENSE logo)
	
	uint8_t logo_00[] = {0x0,0x0,0x0,0x1,0x2,0x4,0x8,0x8};
	uint8_t logo_01[] = {0x0,0xe,0x11,0x0,0x0,0x0,0x0,0x0};
	uint8_t logo_02[] = {0x0,0x0,0x0,0x10,0x8,0x4,0x2,0x2};
	uint8_t logo_10[] = {0x8,0x4,0x2,0x1,0x0,0x0,0x0,0x0};
	uint8_t logo_11[] = {0x0,0x0,0x0,0x0,0x11,0x1f,0x1f,0xe};
	uint8_t logo_12[] = {0x2,0x4,0x8,0x10,0x0,0x0,0x0,0x0};
//	
//		uint8_t logo_00[] = {	0x0,0x0,0x1,0x2,0x4,0x8,0x10,0x10};
//	uint8_t logo_01[] = {0xe,0x11,0x0,0x0,0x0,0x0,0x0,0x0};
//	uint8_t logo_02[] = {	0x0,0x0,0x10,0x8,0x4,0x2,0x1,0x1};
//	uint8_t logo_10[] = {	0x10,0x8,0x4,0x2,0x1,0x0,0x0,0x0};
//	uint8_t logo_11[] = {0x0,0x0,0x0,0x0,0x1f,0x1f,0x1f,0xe};
//	uint8_t logo_12[] = {	0x1,0x2,0x4,0x8,0x10,0x0,0x0,0x0};
#endif
...
{
    double factor = totalCount/80.0;        //12.5  
    int percent = (count+1)/factor; //0.08
    int number = percent/5; //0.016
    int remainder = percent%5;
    if(number > 0) {
      for(int j = 0; j < number; j++) {
				lcd16x2_put_custom_char(lineToPrintOn, j,5);
      }
    }

		lcd16x2_put_custom_char(lineToPrintOn, number,remainder);
    if(number < 16)	//If using a 20 character display, this should be 20!
    {
      ...
      {
				lcd16x2_put_custom_char(lineToPrintOn,j,0);
      }
    }    
}
...
{
		LCD_Clear();
		lcd16x2_create_custom_char(0, logo_00);
		lcd16x2_create_custom_char(1, logo_01);
		lcd16x2_create_custom_char(2, logo_02);
		lcd16x2_create_custom_char(3, logo_10);
		lcd16x2_create_custom_char(4, logo_11);
		lcd16x2_create_custom_char(5, logo_12);
		
		lcd16x2_put_custom_char(0, 0, 0);
		lcd16x2_put_custom_char(0, 1, 1);
		lcd16x2_put_custom_char(0, 2, 2);
		
		lcd16x2_put_custom_char(1, 0, 3);
		lcd16x2_put_custom_char(1, 1, 4);
		lcd16x2_put_custom_char(1, 2, 5);
		LCD_Printf(" SKYSENSE");
}
...
/************************************************************************
                    Init_display_name Function  
*************************************************************************/
void Init_display_name()
{
		// Create custom char
    lcd16x2_create_custom_char(0, char_S);
		lcd16x2_create_custom_char(1, char_K);
		lcd16x2_create_custom_char(2, char_Y);
		lcd16x2_create_custom_char(3, char_S4);
		lcd16x2_create_custom_char(4, char_E);
		lcd16x2_create_custom_char(5, char_N);
		lcd16x2_create_custom_char(6, char_S8);
		lcd16x2_create_custom_char(7, char_E2);
}


/************************************************************************
                    Progress_displayName Function  
*************************************************************************/
void Progress_displayName(int lineToPrintOn){
		int location = 0;
		LCD_Clear();
      for(int j = 4; j < 12; j++) {
				lcd16x2_put_custom_char(lineToPrintOn, j,location);
				location++;
				DELAY_ms(50);
      }
...
/************************************************************************
                    Progress_displaydot Function  
*************************************************************************/
//void Progress_displaydot(uint8_t x, uint8_t y,uint8_t lineToPrintOn) {
//	int location = 0;
//	LCD_Clear();
//  for(int j = 4; j < 12; j++) {
//		lcd16x2_put_custom_char(lineToPrintOn, j,'.');
//		location++;
//		DELAY_ms(100);
//  }
//}
...
void lcd_enable()
{
	GPIO_PinWrite(LCD_EN,LOW);	/* Turn ON the Display */
	DELAY_ms(30);
...
{
	DELAY_ms(50);
	GPIO_PinWrite(LCD_EN,HIGH);	/* Turn OFF the Display */
	LCD_Enable = 0;
	DELAY_ms(50);
}
