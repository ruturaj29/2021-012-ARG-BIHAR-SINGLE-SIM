...
***************************************************************************************************/
void EEPROM_Init(uint32_t v_eepromType_u16, uint8_t sda_pin, uint8_t scl_pin)
{
...
***************************************************************************************************/
void EEPROM_WriteByte(uint32_t v_eepromAddress_u16, uint8_t v_eepromData_u8)
{    
...
***************************************************************************************************/           
uint8_t EEPROM_ReadByte(uint32_t v_eepromAddress_u16)
{
    uint8_t v_eepromLowerAddress_u8;
    uint8_t v_eepromPageNumber_u8;
...
void EEPROM_WriteNBytes(uint32_t v_eepromAddress_u16, uint8_t *ptr_ramAddress_u8, uint16_t v_numOfBytes_u16)
{
...
void EEPROM_ReadNBytes(uint32_t v_eepromAddress_16, uint8_t *ptr_ramAddress_u8, uint16_t v_numOfBytes_u16)
{
    while(v_numOfBytes_u16 !=  0)
    {
...
void EEPROM_WriteString(uint32_t v_eepromAddress_u16, uint8_t *ptr_string_u8)
{
    do
    {
...
void EEPROM_ReadString(uint32_t v_eepromAddress_u16, uint8_t *ptr_destStringAddress_u8)
{
    char eeprom_data;
